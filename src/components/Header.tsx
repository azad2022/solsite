    ...
    <header className="relative w-full z-40 bg-[#05050a]/90 backdrop-blur-xl border-b border-white/[0.08]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-1 bg-white/[0.03] p-1 rounded-full border border-white/10">
          ...
          <a href="/solana-price" onClick={e => { e.preventDefault(); handleNav('/solana-price'); }} className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition-all cursor-pointer text-inherit decoration-none ${currentPath === '/solana-price' ? 'bg-[#14F195]/15 text-[#14F195] border border-[#14F195]/30 shadow-sm shadow-[#14F195]/10' : 'text-slate-300 hover:text-white'}`}>قیمت لحظه‌ای سولانا</a>
