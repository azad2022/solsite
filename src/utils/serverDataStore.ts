...
۲. نویسنده مقاله فقط "تیم تحریریه سولمینت" است.`,
  ...
  chatbot: {
    ...
    initialMessage: 'سلام! 👋 من پشتیبان هوشمند سولمینت هستم. چطور می‌توانم در زمینه ساخت توکن، میم‌کوین، ضرب NFT یا بازیابی اجاره سولانا کمکتان کنم؟',
    systemPrompt: `شما "پشتیبان هوشمند سولمینت (Solmint)" هستید. سولمینت پلتفرم جامع ابزارهای وب۳ و شبکه سولانا به زبان فارسی است (solmint.ir).
