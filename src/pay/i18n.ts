...
const messages = {
  'fa-IR': {
    ...
    overview: 'نمای کلی', transactions: 'تراکنش‌ها', merchants: 'مرچنت‌ها', customers: 'مشتریان', invoices: 'فاکتورها', referrals: 'معرفی و همکاری', reports: 'گزارش‌ها', tickets: 'پشتیبانی', developer: 'توسعه‌دهنده', security: 'امنیت', webhooks: 'وبهوک‌ها',
