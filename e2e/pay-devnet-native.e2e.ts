...
const PAYMENT_AMOUNT_LAMPORTS = 3_000_000;
const MERCHANT_SETTLEMENT_LAMPORTS = 2_970_000;
const GATEWAY_FEE_LAMPORTS = 30_000;
// Fund only the payment amount + gateway fee with a small fee buffer; the previous 520M was already sufficient.
const FUNDER_TOP_UP_LAMPORTS = 3_100_000;
