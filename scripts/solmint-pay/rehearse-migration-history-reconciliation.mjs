...
const plan = {
  ...
  operationOrder: [
    ...
    'VERIFY: require remote migration history to equal baseline + exactly 52 Pay migration versions.',
    'DEPLOY: run db push; because baseline is recorded as applied and the 56 old versions are no longer active history, only the 52 pending Pay migrations may execute.',
...
console.log(JSON.stringify({
  ...
  targetHistory: [BASELINE_VERSION, '<52 Pay migration versions>'],
  repairCommands,
  baselineApply,
  plan,
}, null, 2));
