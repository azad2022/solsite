...
if (!databaseUrl) {
  throw new Error('BETTER_AUTH_DATABASE_URL is required for the Better Auth PostgreSQL integration test.');
}

test('Better Auth PostgreSQL runtime provisions the application identity and serves a secure session lifecycle', async () => {
