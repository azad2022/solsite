...
import { DEFAULT_PAY_LOCALE, directionFor, normalizePayLocale, sectionLabel, translate } from '../src/pay/i18n';
...
test('Pay section labels come from the central message catalogue', () => {
