...
test('webhook egress rejects private, special-use and non-routable addresses', () => {
  for (const ip of ['0.0.0.1','10.0.0.1','100.64.0.1','127.0.0.1','169.254.10.10','172.16.0.1','192.0.0.1','192.0.2.10','192.168.1.1','198.18.0.1','198.51.100.10','203.0.113.10','224.0.0.1','::','::1','fe80::1','fc00::1','fd12::1','ff02::1','2001:db8::1','::ffff:127.0.0.1']) assert.equal(isPublicIp(ip), false, ip);
...
test('pinned transport rejects non-HTTPS, non-443 and fragment targets', () => {
