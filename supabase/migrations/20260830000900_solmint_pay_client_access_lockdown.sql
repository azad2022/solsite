...
alter table public.pay_wallet_ownership_challenges enable row level security;
...
revoke all on table public.pay_wallet_ownership_challenges from anon, authenticated;
