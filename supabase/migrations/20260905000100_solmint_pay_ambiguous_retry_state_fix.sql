-- Allow an ambiguous payment to be retried after reconciliation evidence changes.
-- The application reconciliation engine already requests ambiguous -> verifying;
-- the database state machine must authorize the same transition.
