...
insert into public.users(id, username, full_name, password_hash) values ('pay-audit-user', 'pay-audit-user', 'Pay Audit User', 'audit-fixture-password-hash') on conflict do nothing;
